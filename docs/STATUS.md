...
| feature-0019-message-editing | in-progress | 2026-07-13 | [TASK](../unit/feature-0019-message-editing/docs/TASK.md) | 메시지 편집 Phase 1 백엔드 — 대화 내부 브랜치 트리(parent_message_id+active_leaf·has_branches 게이트·비분기 fast-path·active-path recall CTE)·core/display 두 store 쓰기 정합(checkpoint 1/2, backend-only·dormant, mig 0041, PR #766). 잔여: 엔드포인트·프론트·PB-0008 (Major, PLAN-APPROVED) |
