...
## REV-20260624T091208-META-0009-doc-sync-0624 [SKIPPED:doc-sync-index-mirror-alignment]

- **cycle**: ai/claude/META-0009-doc-sync-0624 — `/_dqa:doc_sync`(no-arg, maintenance) 가 06-24 머지 작업과 정책문서·wiki 간 drift 를 정합. 정본(`unit/<id>/docs/*`)을 새로 쓰지 않고 **색인·미러·서사 표면만** 최신화(SSOT 인덱스 모델 — ADR-0031).
