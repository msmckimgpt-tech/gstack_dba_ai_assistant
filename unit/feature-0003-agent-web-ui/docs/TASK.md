...
- Owner: AI
- Priority: normal
- Last Updated: 2026-05-28 (REQ-20260527-0001 — KB 등록 UI/endpoint 설계 결함으로 제거)

## 2. Task Queue

### TASK-0108 Sprint 3 — Admin-only manual KB ingest (B: DDL/KB 보강) (2026-05-26) — ⚠ 제거됨 (2026-05-28)

> **REQ-20260527-0001** — 설계 결함으로 제거. (1) KB pane 이 대화 첨부(`WebConversationAttachments`)에 의존해 관리 콘솔·대화 화면 독립 원칙 위반. (2) Weight=90 manual fact 가 DB 스키마 변경 시 stale 정의서를 우선 참조하게 되어 AI 답변 오염 위험. `kb_ingest.py` 모듈·테스트는 보존(재설계 시 재활용). CHG-20260528-0109 / REV-20260528-0109 참조.
