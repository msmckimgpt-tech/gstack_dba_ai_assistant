...
| feature-0003-agent-web-ui | in-progress | 2026-09-08 | [TASK](../unit/feature-0003-agent-web-ui/docs/TASK.md) | 여섯 계층 프롬프트 전달 검증 및 조회 실패 은폐 차단 |
...
| feature-0046-native-client | done | 2026-09-08 | [TASK](../unit/feature-0046-native-client/docs/TASK.md) | 실제 업데이트 확인을 통해 1.1.2에서1.2.1 설치·자동 재실행·최신버전 재확인 PASS. |
