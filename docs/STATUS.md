...
| feature-0043-external-llm-bridge | in-progress | 2026-09-10 | [TASK](../unit/feature-0043-external-llm-bridge/docs/TASK.md) | 모델 전환 시 이전 AI 실패 재사용 차단 및 선택 모델 실행 검증 |
...
| feature-0046-native-client | in-progress | 2026-09-10 | [TASK](../unit/feature-0046-native-client/docs/TASK.md) | DQA 1.5.0 출하·설치된 ChatGPT 데스크톱 Codex 연결 및 실제 답변 확인 |
