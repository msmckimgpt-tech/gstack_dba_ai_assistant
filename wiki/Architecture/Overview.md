...
| feature-0041 | feature-0023, feature-0003, feature-0002, feature-0031, feature-0033, feature-0037, feature-0005 | uses | 발견 계약(`/api/ai/*` 네임스페이스·"익명=static contract" 불변식)과 MCP 서버 패턴은 feature-0023/0005 재사용하되 **`ask` 축은 무변경**(원시 도구는 0041). 세션·RBAC·제품 필터·감사·부트스트랩(`routers/oauth_as.py`·`routers/ai_tools.py`·`_bootstrap_schema` WebAiTasks)은 feature-0003, 도구 정의(`modules/tools.py` **무변경**)·datamark sentinel 규약·grounding 조립(`modules/cluster_context.py`, LLM 무호출 조회라 비용 0 재사용)은 feature-0002, 번들 내용물(L0 증거·L2 클러스터 요약·L3 도메인 개요)은 feature-0031/0033/0037. 부하 원장은 feature-0032 토큰 예산과 **단위가 달라 합치지 않는다**(토큰 vs 행/바이트) |
