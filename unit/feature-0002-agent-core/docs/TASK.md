...
## 1. Current Status
- State: insight worker livelock 근본 수정(read-back 2경로 MySQL→PG) + degraded backoff 방어 + 운영 하드닝 완료 (cycle: TASK-0147)
- Owner: AI (본 cycle: insight.py degraded read-back 가드 + loop backoff + config knob + 단위테스트 4)
- Priority: high
