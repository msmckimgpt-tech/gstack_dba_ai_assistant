...
- 적용 경로: 컬럼 펼치기 · 컬럼 접기 · 스키마 펼치기 · 스키마 접기. 더블클릭 이웃확장은 기존의
  **중앙 focus** 동작을 유지한다(관계 추적은 의도적으로 대상을 화면 중앙에 놓는다).
...
- AC-20260813T112100-graph-expand-camera-anim-3: 컬럼·스키마 펼침/접기 4경로 모두에 적용.
