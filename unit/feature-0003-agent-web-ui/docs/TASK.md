...
- Last Updated: 2026-05-21 (TASK-0096 v2 — `설정` pane 을 계정/역할/제품 과 동일한 list-detail 5단 구조로 재정렬 + 검색창. 본 worktree 한정. TASK-0094 Sprint 1 Phase 3 RBAC ship 은 별 worktree 에서 진행 중)
