...
- [x] 루트 진입 경로가 반영되었다
- [x] 문서가 현재 구조를 설명한다
- [x] 엄격한 QA 시나리오가 확정되었다
  ↳ 2026-07-28: TEST-0003 을 실 시나리오(initialize→tools/list→tools/call 왕복 +
     실 DB 메타데이터 반환)로 확정 + 라이브 실측 Run 기록 (TEST.md §2·§3).
     20건 메타데이터(행 수 포함) 수신 PASS.
