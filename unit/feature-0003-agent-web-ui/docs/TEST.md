...
- **POST-DEPLOY 잔여(HF.6)**: ① 컨텐츠 카테고리 헤더 개요 줌 판독 ② 제품 카테고리 밴드 헤더 동일 ③ 칩이 멤버 영역 무침범(reflow 0 육안) ④ 줌 왕복 시 폰트 반동 stale 없음 ⑤ pageerror 0. deploy_scope: included — merge 후 자동 배포.
