...
| # | 항목 | 결과 |
|---|---|---|
| 1 | `GET /api/ai/guide` | **200** · 23,005 bytes ✅ |
| 2 | 본문에 `B.0-1` · `/ai/connect` · "셸 스크립트 실행을 요구하지 말 것" · `invalid_scope` | 전부 **포함** ✅ (= 배포본에 갱신 반영됨) |
| 3 | 익명 노출 인스턴스 데이터(발급물 패턴 grep) | **0건** ✅ (SEC-20260724) |
