...
| feature-0009-group-conversation | in-progress | 2026-06-25 | [TASK](../unit/feature-0009-group-conversation/docs/TASK.md) | 라이브 UX — 참여자 roster·보관 이동·나가기·공유 참여 owner 게이트 + 참가자 per-message 제품 선택·발화(authz, REQ-GC-R7) (cross-cut: 0002/0003) |
