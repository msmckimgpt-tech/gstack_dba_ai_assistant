...
## 1. Current Status
- State: LLM 사용량 회계 복구 — 메인 추론 계측(RC1) + resolved_model(RC2) + 계정별/역할별(RC3) 완료 (cycle: TASK-0163)
- Owner: AI (본 cycle: llm.py `_record_llm_usage` + agent_core `_call_llm` 계측 + alembic 0002 + 테스트 7)
- Priority: high
