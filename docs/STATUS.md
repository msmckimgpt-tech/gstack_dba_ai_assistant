...
| feature-0046-native-client | in-progress | 2026-09-08 | [TASK](../unit/feature-0046-native-client/docs/TASK.md) | DQA 1.2.0 AI별 자동 연결·Windows/WSL 위치 선택 및 재사용. 상세 검증/릴리스는 TASK·REPORT 정본. |
