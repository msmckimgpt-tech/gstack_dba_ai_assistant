...
window.RELEASE_NOTES = {
  ...
  releases: [
    {
      date: "2026-06-24",
      summary: "데이터 용어·설명을 정리하는 메타데이터 화면 · 설명 AI 자동완성 · 그룹 대화 참여자 표시 · 보관/나가기 정리",
      items: [
        {
          type: "new",
          area: "admin",
          title: "데이터 용어 · 코드값 사전과 표 · 컬럼 설명을 관리 콘솔에서 정리",
          detail: "자주 쓰는 업무 용어와 코드값(ENUM)의 뜻, 표 · 컬럼이 어떤 데이터인지 설명을 적어 두면, AI 가 질문을 더 정확히 이해하는 데 활용합니다.",
        },
        {
          type: "new",
          area: "admin",
          title: "메타데이터 설명을 AI 가 초안으로 자동 작성",
          detail: "표 · 컬럼 · 용어 설명을 하나씩 또는 한꺼번에 AI 가 초안으로 채워 주어, 처음 정리하는 부담을 줄였습니다. (초안을 확인한 뒤 저장)",
        },
        {
          type: "improved",
          area: "work",
          title: "그룹 대화 공유 화면에 참여 중인 사용자 표시",
          detail: "공유 관리 화면에서 현재 그 대화에 참여 중인 멤버를 한눈에 확인할 수 있습니다.",
        },
        {
          type: "improved",
          area: "work",
          title: "대화 ‘보관’을 설정 메뉴로 이동 · 그룹 대화에서 ‘나가기’ 추가",
          detail: "대화 설정 팝업에서 보관을 다루도록 정리하고, 참여 중인 그룹 대화에서 직접 나갈 수 있는 ‘나가기’ 를 추가했습니다.",
        },
        {
          type: "new",
          area: "work",
          title: "그룹 대화 알림을 직접 켜고 끄기",
          detail: "그룹 대화의 알림을 원하는 대로 켜고 끌 수 있도록 정리하고, 관련 메뉴 · 프로필 진입을 통합했습니다.",
        },
        {
          type: "improved",
          area: "work",
          title: "공유 링크 ‘참여 허용’ 은 대화 소유자만 설정 가능",
          detail: "다른 사람이 대화에 참여할 수 있게 하는 ‘참여 허용’ 설정은 대화를 만든 소유자만 켤 수 있도록 제한해 안전성을 높였습니다.",
        },
      ],
    },
    {
