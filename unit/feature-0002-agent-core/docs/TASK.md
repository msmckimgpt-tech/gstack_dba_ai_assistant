...
## 1. Current Status
- State: 멀티 datasource — **설계 + 롤아웃 시퀀싱 확정**(ADR-CORE-0003: multi-MySQL 먼저 + security-first, §5 Stage 1/2). Stage 1(multi-MySQL) 구현 cycle 진입 가능 (cycle: TASK-0185)
- Owner: AI (본 cycle: 사용자 결정 3건 → DESIGN/ADR 기록, 코드 mutation 0)
- Priority: high
