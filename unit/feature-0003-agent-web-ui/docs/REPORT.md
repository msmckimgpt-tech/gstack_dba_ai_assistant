...
## 2. Progress
- Planned: TASK-0052 Phase 1B (WebPermissions IsDynamic/ProductId + 제품 권한 backfill + caller-update) → Phase 1C (8 endpoint guard) → Phase 1D (admin UI 'product' group) — 별 cycle 분리
- In Progress: TASK-0052 Phase 1A 완료 (catalog 인자화 refactor, /api/admin/permissions plumbing 검증), TASK-0034 복잡 QA 성능 테스트 (Q4/Q5 재수행 — TASK-0040/0041/0046 선행 완료 상태)
