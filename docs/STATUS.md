...
| feature-0003-agent-web-ui | in-progress | 2026-09-08 | [TASK](../unit/feature-0003-agent-web-ui/docs/TASK.md) | 공유 링크의 참여·fork 진입을 DQA 앱으로 일원화(열람은 브라우저 유지). 클라이언트 재배포 전까지 구버전 앱은 서비스 루트로 degrade |
