...
from modules import cred_crypto  # feature-0011 P5a Step 4: cred_crypto 는 아직 modules/ (후속 step). cred_crypto 는 stdlib 만 의존(datasources/db 미참조) → import-time cycle 없음. shared→modules back-dep, shim 마이그레이션 시 정리.
