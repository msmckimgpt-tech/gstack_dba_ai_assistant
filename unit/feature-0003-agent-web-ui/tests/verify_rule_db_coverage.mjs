...
ok("cache-buster: css 번들이 asset-stamp placeholder(?v=dev)", /css\/admin\.css\?v=dev/.test(adminHtml));
ok("cache-buster: admin.js 가 asset-stamp placeholder(?v=dev)", /admin\.js\?v=dev/.test(adminHtml));
