...
## CHG-20260611-0232
- Date: 2026-06-11 (TASK-0232, **Major §12.3** — 외부 LLM 비용 영향: 제품 프롬프트 "자동 작성" 결과 중간 잘림 해소; 동시세션 insight-reset cycle 이 TASK-0231/CHG-0231 선점→§13.1 재번호 0231→0232)
...
- 동반 변경 (feature-0002): `src/modules/model_catalog.py` 에 `"prompt_gen"` task cap 신설(Claude 20000 / 로컬 3072). agent-core MODIFY.md CHG-20260611-0232 참조.
