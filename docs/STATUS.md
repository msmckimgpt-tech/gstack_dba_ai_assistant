...
| feature-0046-native-client | in-progress | 2026-09-10 | [TASK](../unit/feature-0046-native-client/docs/TASK.md) | 1.4.0 앱 내부 ZIP 갱신·현재 작업 유지·다음 실행 전환 구현 및 Windows 검증, 출하 진행 |
