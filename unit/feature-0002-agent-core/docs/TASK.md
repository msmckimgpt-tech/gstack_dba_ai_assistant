...
## 1. Current Status
- State: T1~T5 Postgres 성능 최적화 + PgBouncer/Replica 전체 활성화 완료 (cycle: TASK-0123)
- Owner: AI (본 cycle: knowledge.py DISTINCT ON/ANY + schema MV/JSONB/kb_invalidations + docker-compose pgbouncer/replica + config/db/kb_backend RO 라우팅)
- Priority: high
