...
- State: in_progress
- Owner: AI
- Priority: minor (TASK-0123 — UX 2차 보완 7개 항목 구현)
- Last Updated: 2026-05-28 (TASK-0123 — 입력창 높이 일치 + 파일 즉시 업로드 + 말풍선 첨부파일 표시 + 첨부파일 다운로드 + 공유뷰 CSV 다운로드 + LLM step/thinking 표시 + 첫 대화 상태 dot 갱신)
