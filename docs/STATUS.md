...
| feature-0009-group-conversation | in-progress | 2026-06-25 | [TASK](../unit/feature-0009-group-conversation/docs/TASK.md) | 사이드바 안 읽은 메세지/@멘션 배지(gc-unread-badge, REQ-GC-R8 read-state, alembic 0019) · 라이브 UX·owner 게이트 (cross-cut: 0002/0003) |
